...
dashboardReady(()=>{
  ...
  async function loadRecentOrders(limit = 5) {
    try {
      ...
      // orders endpoint may return array of objects with different field names
      const normalized = (orders || []).map(o => ({
        id: o.id || o.order_id || o.orderId || o.order_id || '',
        product: o.product || o.product_name || o.items || '',
        customerName: o.customerName || o.customer_name || o.customer || o.name || '',
        amount: Number(o.amount || o.total_amount || o.total || 0),
        status: o.status || 'pending',
        date: o.date || o.order_date || o.created_at || null
      }));
      const recent = normalized.slice(0, limit);
